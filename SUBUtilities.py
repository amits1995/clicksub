...
def log(msg):
    pass #print u"### [%s] - %s" % (__scriptname__, msg,).encode('utf-8')
...
class SubscenterHelper:
    ...
    def login(self, notify_success=False):
        email = "amit.shani1995@gmail.com" #__addon__.getSetting("Email")
        password = "0524000485" #__addon__.getSetting("Password")
